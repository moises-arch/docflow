// SSE endpoint para escanear notificaciones Cleo pendientes con logs en tiempo real.
...
import { runCleoScan } from "../scan-pending/route";
...
export async function POST(_req: NextRequest) {
  ...
  void (async () => {
    try {
      const result = await runCleoScan(ctx.tenantId, log);
